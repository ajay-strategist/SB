...
begin
  ...
  insert into auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, created_at, updated_at, raw_app_meta_data, raw_user_meta_data, aud, role) values
    (admin_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'admin@sbc.edu', extensions.crypt('Admin@1234', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"admin"}'::jsonb, 'authenticated', 'authenticated'),
    (mentor1_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'mentor.priya@sbc.edu', extensions.crypt('Mentor@123', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"mentor"}'::jsonb, 'authenticated', 'authenticated'),
    (mentor2_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'mentor.joseph@sbc.edu', extensions.crypt('Mentor@123', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"mentor"}'::jsonb, 'authenticated', 'authenticated'),
    (hod1_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'hod.science@sbc.edu', extensions.crypt('HOD@1234', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"hod"}'::jsonb, 'authenticated', 'authenticated'),
    (student1_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'anjali.krishna@gmail.com', extensions.crypt('Student@123', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"student"}'::jsonb, 'authenticated', 'authenticated'),
    (student2_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'rahul.menon@gmail.com', extensions.crypt('Student@123', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"student"}'::jsonb, 'authenticated', 'authenticated'),
    (student3_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'sneha.pillai@gmail.com', extensions.crypt('Student@123', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"student"}'::jsonb, 'authenticated', 'authenticated'),
    (student4_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'arjun.babu@gmail.com', extensions.crypt('Student@123', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"student"}'::jsonb, 'authenticated', 'authenticated'),
    (parent1_uid, '00000000-0000-0000-0000-000000000000'::uuid, 'krishna.parent@gmail.com', extensions.crypt('Parent@123', extensions.gen_salt('bf')), now(), now(), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"role":"parent"}'::jsonb, 'authenticated', 'authenticated')
